...
public class BulkImportComponent extends Base {
    ...
    public void identityUploadTest(String AppName) throws IOException, InterruptedException, AWTException {
        ...
        screenshotService.takeScreenShot(this.getClass().getSimpleName(),
                Thread.currentThread().getStackTrace()[1].getMethodName());
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Description",
                "Excel Data writter works");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "X-Platform Indicator",
                "On Platform");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Vendor Name", "Bender");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Level Of Customisation",
                "COTS with minor modifications");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Application Platform",
                "Other");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Primary Dev Language",
                "Cobolt");
    ...
    public void businessUploadTest(String AppName) throws IOException, InterruptedException, AWTException  {
        ...
        screenshotService.takeScreenShot(this.getClass().getSimpleName(),
                Thread.currentThread().getStackTrace()[1].getMethodName());
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Business Category",
                "Business Product");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist",
                "Critical Business Function", "Markets and Structuring");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Business Capability",
                "This is a mfz test");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Business Fit", "Average");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Technical Fit", "Good");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Application Lifecycle",
                "Mature");
        screenshotService.takeScreenShot(this.getClass().getSimpleName(),
                Thread.currentThread().getStackTrace()[1].getMethodName());
    }
    ...
    public void intergrationsUploadTest(String AppName) throws IOException, InterruptedException, AWTException  {
        ...
        screenshotService.takeScreenShot(this.getClass().getSimpleName(),
                Thread.currentThread().getStackTrace()[1].getMethodName());
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Integration Completed",
                "true");
    }
    ...
    public void ownershipUploadTest(String AppName) throws IOException, InterruptedException, AWTException  {
        ...
        screenshotService.takeScreenShot(this.getClass().getSimpleName(),
                Thread.currentThread().getStackTrace()[1].getMethodName());
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "CIO / IT Manager",
                "Deepak Singh");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Business Owner",
                "Aline Kruger");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Technical Owner", "Keruna Pillay");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Architect",
                "Yusuf Bata");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "WhatsWatt Champion_1",
                "Nakedi Mabusela");
    ...
    public void criticalityUploadTest(String AppName) throws IOException, InterruptedException, AWTException  {
        ...
        this.excelService.readAndWriteExcel("Maximum business tolerance for service downtime ,Recovery Time Objective ,Recovery Time Objective (RTO) in minutes", "196");
        this.excelService.readAndWriteExcel("Maximum business tolerance for data loss ,Recovery Point Objective (RPO) in minutes", "420");
        this.excelService.readAndWriteExcel("Application Requires Support From", "Resources and skills required to maintain the application are usually available in the marketplace.");
        javaScriptServices.scrollDown();
        seleniumUtilities.click(chooseInput);
        waitForService.waitForPulse(5);
        System.out.println(this.excelService.getFileName().getAbsolutePath());
        ...
        screenshotService.takeScreenShot(this.getClass().getSimpleName(),
                Thread.currentThread().getStackTrace()[1].getMethodName());
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "24hr Downtime Impact",
                "Minimal Impact");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Maximum business tolerance for service downtime ,Recovery Time Objective ,Recovery Time Objective (RTO) in minutes",
                "196");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Maximum business tolerance for data loss ,Recovery Point Objective (RPO) in minutes", "420");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Application Requires Support From",
    ...
    public void lifecycleUploadTest(String AppName) throws IOException, InterruptedException, AWTException {
        ...
        screenshotService.takeScreenShot(this.getClass().getSimpleName(),
                Thread.currentThread().getStackTrace()[1].getMethodName());
        // javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Phase-in/planned from date",
        //         "2021/12/31");
        // javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Productive/fully used from date",
        //         "2022/01/01");
        // javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Phase-out/contained from date", "2023/01/01");
        // javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Retire/out of support from date",
        //         "COTS with minor modifications");
        // javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Date Of Last Major Upgrade Enhancement",
        //         "Other");
    }
    ...
    public void infrastructureUploadTest(String AppName) throws IOException, InterruptedException, AWTException {
        ...
        screenshotService.takeScreenShot(this.getClass().getSimpleName(),
                Thread.currentThread().getStackTrace()[1].getMethodName());
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Hosting Location",
                "RMB Data Centre");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Primary Production Environment",
                "Red 3");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Is DR in place", "true");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Works In Standin",
                "false");
    }
    ...
    public void securityUploadTest(String AppName) throws IOException, InterruptedException, AWTException {
        ...
        screenshotService.takeScreenShot(this.getClass().getSimpleName(),
                Thread.currentThread().getStackTrace()[1].getMethodName());
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "System Classification",
                "Business Critical");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Functional Classification",
                "Insurance");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Data Classification", "Public");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Internet Facing",
                "true");
                javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "3rd party integration",
                "false");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "POPI Data",
                "true");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "PCI Data", "false");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "2FA Back End",
                "Digitag");
                javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "2FA Front End",
                "Other");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "CCS",
                "Full");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "IAG Onboarded Access review", "Automated");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "IAG Onboarded Role-based provisioning",
                "Manual");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "PAM deployed on all privileged accounts", "Unspecified");
        javaScriptServices.highlightElementTable("ApplicationsListForm:ExportCard:datalist", "Primary Authentication Mechanism",
                        "AD (Single Sign On)");        
    }
